 ...
 * @param {(function(!Object): boolean)=} isPending Function which determines if
 * a response is considered to be pending for retry purposes.
 * @param {TravisStatusQueryOptions=} options Query options.
 * @return {Promise<!Object>} Promise with the response content or Error.
 * @private
 */
function queryWithWait(query, isPending, options) {
